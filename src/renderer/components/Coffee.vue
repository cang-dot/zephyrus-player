  ...
  <div class="relative inline-block">
    <n-popover trigger="hover" placement="top" :show-arrow="true" :raw="true" :delay="100">
      ...
      <div class="p-6 rounded-lg shadow-lg bg-light dark:bg-gray-800">
        ...
        <div class="mt-4">
          <p
            class="text-sm text-gray-700 dark:text-gray-200 text-center cursor-pointer hover:text-[var(--accent-color)]"
            @click="copyText"
          >
        ...
        <div class="mt-4">
          <!-- 璧炶祻鍒楄〃鍦板潃 -->
          <p
            class="text-sm text-[var(--accent-color-dark)] dark:text-gray-200 text-center cursor-pointer hover:text-[var(--accent-color)]"
            @click="toDonateList"
          >
